import { Component, OnInit, OnDestroy, AfterViewInit, ViewChild, Output, Input, EventEmitter, ChangeDetectorRef } from '@angular/core';
...
export class CicdCreateProjectPageComponent implements OnInit, OnDestroy, AfterViewInit {
